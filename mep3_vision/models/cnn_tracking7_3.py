...
class CNNTracking7(nn.Module):
    def __init__(self, num_residual_blocks1=2, num_residual_blocks2=12, num_residual_blocks3=5,
        ...
        self.res_blocks2_1 = self._make_residual_blocks(filter_count, filter_count * 2, num_residual_blocks_branch2 // 3, True, dropout1)
        self.res_blocks2_2 = self._make_residual_blocks(filter_count * 2, filter_count * 4, num_residual_blocks_branch2 // 3, True, dropout1)
        self.res_blocks2_3 = self._make_residual_blocks(filter_count * 4, filter_count * 8, num_residual_blocks_branch2 // 3, True, dropout1)

        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(5 * 7 * filter_count * 8, 7 * 6)
